...
type UsersDB interface {
	Create(ctx context.Context, passwordHash string) (uuid.UUID, error)
	ChangePasswordHash(ctx context.Context, userID uuid.UUID, passwordHash string) error
...
type NotesDB interface {
	...
	GetNotes(ctx context.Context, userID uuid.UUID) ([]NoteSmall, error)
}
...
// user
func (d *usersDB) Create(ctx context.Context, passwordHash string) (uuid.UUID, error) {
	const query = "INSERT INTO users (password_hash) VALUES ($1) RETURNING user_id"
	var userID uuid.UUID
	err := d.db.GetContext(ctx, &userID, query, passwordHash)
	return userID, err
}

func (d *usersDB) ChangePasswordHash(ctx context.Context, userID uuid.UUID, passwordHash string) error {
...
func (d *usersDB) Delete(ctx context.Context, userID uuid.UUID) error {
...
func (d *usersDB) GetUser(ctx context.Context, userID uuid.UUID) (User, error) {
...
// note
func (d *notesDB) Create(ctx context.Context, userID uuid.UUID) (uuid.UUID, error) {
...
func (d *notesDB) GetNotes(ctx context.Context, userID uuid.UUID) ([]NoteSmall, error) {
